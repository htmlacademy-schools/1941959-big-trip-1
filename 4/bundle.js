...
/* harmony export */   "addNewPoint": () => (/* binding */ addNewPoint)
/* harmony export */ });
...
/***/ "./src/view/add-without-destination.js":
/*!*********************************************!*\
  !*** ./src/view/add-without-destination.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "addWithoutDestination": () => (/* binding */ addWithoutDestination)
/* harmony export */ });
...
/***/ "./src/view/add-without-offers.js":
/*!****************************************!*\
  !*** ./src/view/add-without-offers.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "addWithoutOffers": () => (/* binding */ addWithoutOffers)
/* harmony export */ });
const addWithoutOffers = () => `<li class="trip-events__item">
              <form class="event event--edit" action="#" method="post">
                <header class="event__header">
                  <div class="event__type-wrapper">
                    <label class="event__type  event__type-btn" for="event-type-toggle-1">
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "headFilters": () => (/* binding */ headFilters)
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "headInfo": () => (/* binding */ headInfo)
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "headNavigation": () => (/* binding */ headNavigation)
/* harmony export */ });
...
/*!*********************!*\
  ...
  \*********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _view_content_list_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./view/content-list.js */ "./src/view/content-list.js");
/* harmony import */ var _view_content_filters_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./view/content-filters.js */ "./src/view/content-filters.js");
/* harmony import */ var _view_head_navigation_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./view/head-navigation.js */ "./src/view/head-navigation.js");
/* harmony import */ var _view_head_filters_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./view/head-filters.js */ "./src/view/head-filters.js");
/* harmony import */ var _view_head_info_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./view/head-info.js */ "./src/view/head-info.js");
/* harmony import */ var _view_add_new_point_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./view/add-new-point.js */ "./src/view/add-new-point.js");
/* harmony import */ var _view_add_without_destination_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./view/add-without-destination.js */ "./src/view/add-without-destination.js");
/* harmony import */ var _view_add_without_offers_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./view/add-without-offers.js */ "./src/view/add-without-offers.js");
...
renderTemplate(headInfo, (0,_view_head_info_js__WEBPACK_IMPORTED_MODULE_4__.HeadInfo)(), RenderPosition.AFTERBEGIN);
const contentFilter = document.querySelector('.trip-events');
renderTemplate(contentFilter, (0,_view_content_filters_js__WEBPACK_IMPORTED_MODULE_1__.ContentFilters)(), RenderPosition.AFTERBEGIN);
const contentList = document.querySelector('.trip-events');
renderTemplate(contentList, (0,_view_content_list_js__WEBPACK_IMPORTED_MODULE_0__.ContentList)(), RenderPosition.BEFOREEND);
const siteFilterList = siteList.querySelector('.trip-controls__navigation');
renderTemplate(siteFilterList, (0,_view_head_navigation_js__WEBPACK_IMPORTED_MODULE_2__.HeadNavigation)(), RenderPosition.BEFOREEND);
const headFilters = document.querySelector('.trip-controls__filters');
renderTemplate(headFilters, (0,_view_head_filters_js__WEBPACK_IMPORTED_MODULE_3__.HeadFilters)(), RenderPosition.BEFOREEND);
const addNewPoint = siteList.querySelector('.trip-events__list');
renderTemplate(addNewPoint, (0,_view_add_new_point_js__WEBPACK_IMPORTED_MODULE_5__.AddNewPoint)(), RenderPosition.BEFOREBEGIN);
const addWithoutDestination = siteList.querySelector('.trip-events__list');
renderTemplate(addWithoutDestination, (0,_view_add_without_destination_js__WEBPACK_IMPORTED_MODULE_6__.AddWithoutDestination)(), RenderPosition.BEFOREBEGIN);
const addWithoutOffers = siteList.querySelector('.trip-events__list');
renderTemplate(addWithoutOffers, (0,_view_add_without_offers_js__WEBPACK_IMPORTED_MODULE_7__.AddWithoutOffers)(), RenderPosition.BEFOREBEGIN); //const addEventBtn = document.querySelector('.trip-main__event-add-btn');
//const addNewPoint = siteList.querySelector('.trip-events__list');
